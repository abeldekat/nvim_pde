...
keys("n", "]t", function() require("todo-comments").jump_next() end, { desc = "Next todo comment", silent = true })
keys("n", "[t", function() require("todo-comments").jump_prev() end, { desc = "Previous todo comment", silent = true })
