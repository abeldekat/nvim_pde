--          ╭─────────────────────────────────────────────────────────╮
--          │          DEPRECATED in favor of mini.operators          │
--          ╰─────────────────────────────────────────────────────────╯
...
vim.keymap.set(
  ...
  { desc = "Substitute operator", silent = true }
)
-- {"gss", function() require("substitute").line() end, desc = "Substitute line"},
vim.keymap.set("x", "gs", function() require("substitute").visual() end, { desc = "Substitute visual", silent = true })
...
vim.keymap.set(
  ...
  { desc = "Exchange operator", silent = true }
)
...
vim.keymap.set(
  ...
  { desc = "Exchange visual", silent = true }
)
...
vim.keymap.set(
  ...
  { desc = "Range operator", silent = true }
)
vim.keymap.set("n", "gmm", function() require("substitute.range").word() end, { desc = "Range word", silent = true })
vim.keymap.set("x", "gm", function() require("substitute.range").visual() end, { desc = "Range visual", silent = true })
